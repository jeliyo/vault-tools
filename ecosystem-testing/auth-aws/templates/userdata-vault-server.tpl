...
vault namespace create test-namespace
...
vault auth enable -path=ec2 aws
vault write -force auth/ec2/config/client
vault write auth/ec2/config/client iam_server_id_header_value=vault.example.com
vault write auth/ec2/role/dev-role-ec2 auth_type=ec2 bound_ami_id=${ami_id} policies=myapp ttl=24h
